...
app.controller('accountController', function($state,$scope,APIService,UserService,$stateParams, formData) {
...
app.controller('accountProfileController', 
  function($scope, $rootScope, Upload, cloudinary, APIService) { 
